...
export async function POST(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  // Scoped by owner, not just by id: a batch id is unguessable but secrecy is
  // not authorization, and the staged rows hold another reader's highlight text.
  // Someone else's batch reads as "not found" — no signal that the id was real.
